...
Label(f,font=("Lucida Calligraphy",15,'bold'),text="Egg.......Rs.7/egg",fg="black",bg="lightgreen").place(x=10,y=260)
...
#ENTRY WORK
f1=Frame(root,bd=5,height=370,width=370,relief=RAISED)
f1.pack()
